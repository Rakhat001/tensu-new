...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-background relative selection:bg-primary/30 selection:text-primary-50">
      ...
      <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-primary/20 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[400px] h-[400px] bg-purple-600/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <section className="pt-32 lg:pt-48 pb-24 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-3 tensu-card p-8 lg:p-10 border border-white/10 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all"
                      placeholder={t.namePlaceholder}
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">{t.club}</label>
                    <input
                      type="text"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all resize-none"
                ...
                <button
                  ...
                  className="w-full h-14 bg-primary hover:bg-primary/90 text-white rounded-xl font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] mt-4"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="tensu-card p-8 bg-gradient-to-br from-primary/10 via-purple-500/10 to-pink-500/10 border-white/10 hover:border-white/20 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="w-full h-12 bg-white/10 hover:bg-white/20 border border-white/10 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all"
                  >
                    {t.tgBtn}
              ...
              <div className="tensu-card p-8 border-white/10">
                ...
                <ul className="space-y-4">
                  {t.nextSteps.map((step, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 text-xs font-black mt-0.5">
                        {idx + 1}
                      </div>
